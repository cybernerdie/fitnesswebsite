      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <td>
           ...
           <td>
              <?php
                  if(strlen($Bio)>8){$Bio= substr($Bio,0,8).'..';}
                   echo $Bio ;
               ?>
           </td>
           <td>
              <?php
                  if(strlen($Skills)>11){$Skills= substr($Skills,0,11).'..';}
                     echo $Skills ;
              ?>
          </td>
          <td>
              <?php
                  if(strlen($Location)>6){$Location= substr($Location,0,6).'..';}
                     echo $Location ;
               ?>
          </td>
            ...
            <td>
              <?php
                  if(strlen($Email)>6){$Email= substr($Email,0,6).'..';}
                     echo $Email ;
               ?>
          </td>
              ...
              <td>
              <?php
                  if(strlen($Phone)>6){$Phone= substr($Phone,0,6).'..';}
                     echo $Phone ;
               ?>
          </td>
                        <td>
              <?php
                  if(strlen($Position)>6){$Position= substr($Position,0,6).'..';}
                     echo $Position ;
               ?>
          </td>
              <td>
                <a href="Edittrainer.php?id=<?php echo $Id; ?>"><span class="btn btn-warning">Edit</span></a>
                <a href="Deletetrainer.php?id=<?php echo $Id; ?>"><span class="btn btn-danger">Delete</span></a>
              </td>
                    </tr>
                     <?php } ?> 
                </table>
