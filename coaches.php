...
$result_count = "SELECT COUNT(*) as total_records FROM trainers";
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="coaches.php" class="nav-link">Coaches</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-3 bread">Gym Trainers</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          elseif (isset($_GET["page"])) {
            ...
            $sql ="SELECT * FROM trainers ORDER BY id desc LIMIT $ShowPostFrom,$TotalPerPage";
          ...
          elseif (isset($_GET["category"])) {
            ...
            $sql = "SELECT * FROM trainers WHERE category='$Category' ORDER BY id desc";
            $stmt=$ConnectingDB->query($sql);
          }

          // The default SQL query
          else{
            $sql  = "SELECT * FROM trainers ORDER BY id desc LIMIT 0,$TotalPerPage";
              $stmt =$ConnectingDB->query($sql);
          }
          ...
          ?>
							<div class="col-md-4 col-sm-6 d-flex ftco-animate">
		              ...
		              <div class="text p-4 float-right d-block" style="background-color:transparent; width:100%">
		              	<div class="meta">
		                  <div><a href="#" class="meta-chat"><span class="icon-cha"></span> </a></div><br>
                             <span class="subheading" style="font-size: 12px; color: gray; text-transform: uppercase"><?php echo htmlentities($Position); ?></span>
		                </div>
		                <h3 class="heading mt-2"><a href="trainer.php?id=<?php echo $TrainerId; ?>"><?php echo htmlentities($Name); ?></a></h3>
		                <p>Location: <?php echo htmlentities($Location); ?></p> 
    ...
    <section class="ftco-appointment">
    	...
    	<div class="container-wrap">
           ...
           ?>
	    			...
	    			<form action="coaches.php" class="appointment-form" method="post">
	    				<div class="d-md-flex">
