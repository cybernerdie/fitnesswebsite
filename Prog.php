      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <td>
           ...
           <td>
              <?php
                  if(strlen($Description)>8){$Description= substr($Description,0,8).'..';}
                   echo $Description ;
               ?>
           </td>
           <td>
              <?php
                  if(strlen($Benefit)>11){$Benefit= substr($Benefit,0,11).'..';}
                     echo $Benefit ;
              ?>
          </td>
          <td>
              <?php
                  if(strlen($Duration)>6){$Duration= substr($Duration,0,6).'..';}
                     echo $Duration ;
               ?>
          </td>
              ...
              <td>
              <?php
                  if(strlen($Trainer)>6){$Trainer= substr($Trainer,0,6).'..';}
                     echo $Trainer ;
               ?>
          </td>
              <td>
                <a href="editprogram.php?id=<?php echo $Id; ?>"><span class="btn btn-warning">Edit</span></a>
                <a href="DeleteProgram.php?id=<?php echo $Id; ?>"><span class="btn btn-danger">Delete</span></a>
              </td>
                    </tr>
                     <?php } ?> 
                </table>
