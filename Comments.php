    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Unapproved Comments</h6>
            </div>
            <div class="card-body">
          ...
          <td>
              <?php
                  if(strlen($CommenterName)>20){$CommenterName= substr($CommenterName,0,18).'..';}
                   echo $CommenterName;
               ?>
           </td>
           <td>
              <?php
                  if(strlen($CommentContent)>18){$CommentContent= substr($CommentContent,0,18).'..';}
                   echo $CommentContent ;
               ?>
           </td>
           <td>
              <?php
                  if(strlen($DateTimeOfComment)>15){$DateTimeOfComment= substr($DateTimeOfComment,0,15).'..';}
                     echo $DateTimeOfComment ;
              ?>
          </td>
          <td> <a href="ApproveComments.php?id=<?php echo $CommentId;?>" class="btn btn-success">Approve</a>  </td>
              <td>
                 <a href="DeleteComments.php?id=<?php echo $CommentId;?>" class="btn btn-danger">Delete</a> 
              </td>
                    </tr>
                     <?php } ?> 
                </table>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Approved Comments</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                        <?php
           ...
           echo SuccessMessage();
           ?>
                <table id="post_data1" class="table table-striped table-bordered">
                  <thead>
                    <tr>
              <td>#</td>
              <td>Name</td>
         ...
         <td>
              <?php
                  if(strlen($ApprovedBy)>18){$ApprovedBy= substr($ApprovedBy,0,18).'..';}
                   echo $ApprovedBy ;
               ?>
           </td>
           <td>
