      ...
      <div class="container">
        <div class="row">
          ...
          // The default SQL query
            ...
            $sql  = "SELECT * FROM trainers  WHERE id= '$PostIdFromURL'";
          ...
          ?>
           ...
           <div class="meta">
               <h3>About Me</h3> <hr>
               <div class="mb-3"><?php echo htmlentities($Bio); ?></div>
                              <h3>What to Expect</h3> <hr>
               <div class="mb-3"><?php echo htmlentities($Skills); ?></div> <br>
		                 
                <h3>Contact</h3> <hr>
               Email: <?php echo htmlentities($Email); ?> <br>
               Phone: <?php echo htmlentities($Phone); ?><br>
                <div class="mb-3"> Location: <?php echo htmlentities($Location); ?> </div>
              </div>
