  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       global $ConnectingDB;
       $sql  = "SELECT * FROM category WHERE id='$SarchQueryParameter'";
       $stmt = $ConnectingDB ->query($sql);
       while ($DataRows=$stmt->fetch()) {
       ...
       ?>
      <form class="" action="editcategory.php?id=<?php echo $SarchQueryParameter; ?>" method="post" enctype="multipart/form-data">
        <div class="card bg-primary text-light mb-3">
          <div class="card-body">
            <div class="form-group">
                  <label for="title"> <span class="FieldInfo"> Trainer Name: </span></label>
               <input class="form-control" type="text" name="Category" id="title" placeholder="Type title here" value="<?php echo $TitleToBeUpdated; ?>">
            </div>
            <div class="row">
