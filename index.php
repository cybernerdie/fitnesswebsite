...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider js-fullheight owl-carousel ftco-degree-bottom">
      <div class="slider-item js-fullheight" style="background-image: url(images/hm.jfif);">
      ...
      <div class="slider-item js-fullheight" style="background-image: url(images/hm2.jpeg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
    ...
    <section class="ftco-about d-md-flex bg-light">
    	<div class="one-half img" style="background-image: url(images/ab.jpeg);">
    ...
    <section class="ftco-section bg-light">
    	<div class="container-fluid">
          ...
          // The default SQL query
            ...
            $sql  = "SELECT * FROM trainers ORDER BY id desc LIMIT 0,3";
          ...
          ?>
    				...
    				<div class="coach align-items-stretch">
	    				...
	    				<div class="text bg-white p-4 ftco-animate">
	    					...
	    					<p><?php if (strlen($Bio)>130) { $Bio = substr($Bio,0,130)."...";} echo htmlentities($Bio); ?></p>
	    					<p></p>
	    				</div>
	    			</div>
    			</div>
        ...
        <div class="container">
        	...
        	<div class="col-md-4 text-center">
        		<a href="coaches.php" class="btn-custom py-4">More Coaches <span class="ion-ios-arrow-down ml-2"></span></a>
        	</div>
        </div>
	  	</div>
    </section>
	  ...
	  <section class="ftco-section">
        ...
        <div class="row">
          ...
          // The default SQL query
            ...
            $sql  = "SELECT * FROM programs ORDER BY id desc LIMIT 0,3";
            $stmt =$ConnectingDB->query($sql);
          }
          while ($DataRows = $stmt->fetch()) {
        	...
        	<div class="col-md-6 col-lg-4 col-sm-6">
        		<div class="coach align-items-stretch">
                        <a href="programs.php?id=<?php echo $ProgramId; ?>">
                         <img src="Uploads/<?php echo htmlentities($Image); ?>" class="block-20 img" href="trainer.php" /></a>  <div class="text mt-3">
        				<h3><a href="#"><?php echo htmlentities($Name); ?></a></h3>
        				<p><?php if (strlen($Description)>100) { $Description = substr($Description,0,130)."...";} echo htmlentities($Description); ?></p>
        			</div>
        		</div>
        	</div>
	  	...
	  	<div class="container">
	  		<div class="row mt-4 justify-content-center ftco-animate">
        	<div class="col-md-4 text-center">
        		<a href="program.php" class="btn-custom py-4">View More Program <span class="ion-ios-arrow-down ml-2"></span></a>
        	</div>
        </div>
	  	</div>	
	  </section>
                ...
                <div class="testimony-wrap p-4 pb-5">
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/tran.jpg)">
		                    <span class="quote d-flex align-items-center justify-content-center">
		                      <i class="icon-quote-left"></i>
		                    </span>
		                  </div>
		                  <div class="ml-4">
		                  	<p class="name">Josh Paul</p>
        ...
        <div class="row d-flex">
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 float-right d-block">
                  ...
                  <div><a href="#" class="meta-chat"><a href="#" class="meta-chat"><span class="icon-chat"></span> <?php echo ApproveCommentsAccordingtoPost($PostId);?></a></a></div>
                </div>
         ...
         <?php } ?>
        	...
        	<div class="container">
	  		<div class="row mt-4 justify-content-center ftco-animate">
        	<div class="col-md-4 text-center">
        		<a href="blog.php" class="btn-custom py-4">View Blogs <span class="ion-ios-arrow-down ml-2"></span></a>
        	</div>
        </div>
	  	</div>
    </section>
