...
<div class="row">
  <div class="col">
  <p class="lead text-center">Theme By | Josh Paul | <span id="year"></span> &copy; ----All right Reserved.</p>
  <p class="text-center small"><a style="color: white; text-decoration: none; cursor: pointer;" href="http://about.me/pauljoshua/coupons/" target="_blank"> This site is only used for Study purpose about.me/pauljoshua have all the rights. no one is allow to distribute copies other then <br>&trade; about.me/pauljoshua &trade;  Udemy ; &trade; Skillshare ; &trade; StackSkills</a></p>
   </div>
 </div>
</div>
</footer>
